...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_8 = __VLS_asFunctionalComponent(__VLS_7, new __VLS_7({ ...{ class: ((__VLS_ctx.cn('pointer-events-none block h-4 w-4 rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0'))) }, }));
    const __VLS_9 = __VLS_8({ ...{ class: ((__VLS_ctx.cn('pointer-events-none block h-4 w-4 rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-4 data-[state=unchecked]:translate-x-0'))) }, }, ...__VLS_functionalComponentArgsRest(__VLS_8));
    var __VLS_13 = {};
