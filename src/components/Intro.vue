...
<template>
  <div class="min-h-[100vh] flex flex-col justify-center max-w-4xl mx-auto px-4 py-8 space-y-6">
    ...
    <Card class="transition-all duration-300 hover:-translate-y-1">
      <CardHeader>
        <CardTitle>Why IPAC Consulting?</CardTitle>
      </CardHeader>
      <CardContent>
    ...
    <Card class="transition-all duration-300 hover:-translate-y-1">
      <CardHeader>
        <CardTitle>Why I build this website?</CardTitle>
      </CardHeader>
      <CardContent>
    ...
    <div class="mt-8 flex justify-center gap-4">
      <Button variant="default" @click="emit('navigate-to-relocation')">Relocation Plan</Button>
      <Button variant="secondary" @click="emit('navigate-to-map')">Journey to IPAC</Button>
    </div>
  </div>
</template>
